...
wave: closed
verdict: "TRACK-005 closed 2026-09-05 (too large). Canonical NOW board is execution-board-follow-through.md for TRACK-007. Nested EP-074…077 done (human-verified 2026-09-05). Path A EP-045/046 leftover frozen."
---

# Execution board — hand-on-paper

> **Archive.** [TRACK-005](../tracks/TRACK-005-hand-on-paper.md) **done** 2026-09-05. Canonical NOW board: [execution-board-follow-through.md](./execution-board-follow-through.md) for [TRACK-007](../tracks/TRACK-007-follow-through.md).

**Historical board** for TRACK-005. Tool-system interrupt [TRACK-006](../tracks/TRACK-006-tool-system-refactor.md) **done** 2026-08-27. Inverse-undo implement **done**. Erase product bound 2026-08-29. Erase implement **human-verified** 2026-08-31. [STORY-EP-069](./stories/STORY-EP-069.md) **done** (human-verified 2026-08-31). Nested [STORY-EP-074](./stories/STORY-EP-074.md)…[STORY-EP-077](./stories/STORY-EP-077.md) **done** (human-verified 2026-09-05). Clipboard [STORY-EP-044](./stories/STORY-EP-044.md) **done** (human-verified 2026-09-04). Path B endpoint ink [STORY-EP-047](./stories/STORY-EP-047.md) **done** (human-verified 2026-09-05). Path A [STORY-EP-045](./stories/STORY-EP-045.md) / [STORY-EP-046](./stories/STORY-EP-046.md) **blocked** leftover. Remainder (follow field test, barrel, Device Settings, attachments, manual create, field latency, logarithmic hit-test, clipops split) → TRACK-007.
...
| Nested | 4 **done** | [STORY-EP-074](./stories/STORY-EP-074.md)…[STORY-EP-077](./stories/STORY-EP-077.md) human-verified 2026-09-05. Log-hit-test `depends_on` unblocked. |
...
| Queued | — | Logarithmic hit-test [STORY-EP-078](./stories/STORY-EP-078.md)…[STORY-EP-080](./stories/STORY-EP-080.md) **draft** ([ADR-0040](../../.docs/adr/ADR-0040-logarithmic-hit-test.md) proposed). [STORY-EP-073](./stories/STORY-EP-073.md) clipboard clipops split later. Device Settings still wait. Follow hardware score still outstanding. Infini undo apply parked (IN-038 cancelled). Path A connector toolbar frozen (EP-045/046). Attachments EP-048/049 still queued. |
...
NOW: field follow-ups EP-070…072 ready; nested EP-074…077 done (human-verified 2026-09-05); log-hit-test EP-078…080 draft (queued); clipboard product done (EP-044); Path B endpoint ink done (EP-047); Path A EP-045/046 frozen; do not start EP-073
cursor: pick EP-070 or EP-071 or EP-072 (WIP 2); EP-078…080 unblocked but do not start until the human picks this wave; do not continue TRACK-006; IN-038 cancelled; do not start Path A toolbar
```
...
| **W-nested** | **done** 2026-09-05 | serial | [STORY-EP-074](./stories/STORY-EP-074.md)…[STORY-EP-077](./stories/STORY-EP-077.md) nested ink-box. Human-verified. |
| **W-log-hit-test** | queued (draft) | serial then ∥ migrates | [STORY-EP-078](./stories/STORY-EP-078.md) R-tree · [STORY-EP-079](./stories/STORY-EP-079.md) point callers · [STORY-EP-080](./stories/STORY-EP-080.md) range 80% callers. **Not NOW.** Depends on nested tap/reparent. [ADR-0040](../../.docs/adr/ADR-0040-logarithmic-hit-test.md) proposed. |
...
| **W-endpoint-ink** | **done** 2026-09-05 | | Path B [STORY-EP-047](./stories/STORY-EP-047.md) Recognize and preserve endpoint ink. Human-verified on device. |
| **W4** | queued (partial freeze) | | Path A toolbar [STORY-EP-045](./stories/STORY-EP-045.md) / [STORY-EP-046](./stories/STORY-EP-046.md) **blocked**. Attachments [STORY-EP-048](./stories/STORY-EP-048.md) / [STORY-EP-049](./stories/STORY-EP-049.md) still queued. |
| **W5** | queued | | barrel BDD then EP-052 / EP-058 / EP-057. IN-035 cancelled. |
| **W6** | queued | | manual create |
| **Frozen** | — | | REQ-15 · REQ-08 · EP-035 parking · DeviceMap invert UI · Mouse DragHandler · Path A connector toolbar (EP-045/046) |
...
| F-13 | REQ-13 endpoint styles | Should | [ADR-0038](../../.docs/adr/ADR-0038-endpoint-ink-face-frame.md); [SRS-EP-74](../../.docs/modules/epaper/features/connector-ink/srs-product.md#srs-ep-74-endpoint-ink-product) | EP-045 **blocked** (Path A frozen) | Path B [STORY-EP-047](./stories/STORY-EP-047.md) **done** (human-verified 2026-09-05); Path A EP-045/046 **blocked** | W-endpoint-ink / W4 | — | — | Epaper is Path B only this campaign. Path A closed-style toolbar is Infini / web-desktop later. |
...
| STORY-EP-074 | Nested ink-box RenderingContext and tap-select | P0 | SRS-EP-76 / EP-77 / EP-11; [ADR-0039](../../.docs/adr/ADR-0039-nested-ink-box-rendering.md) | none | **done** | W-nested | — | — | Human-verified 2026-09-05. Child wins tap; marquee stays top-level. Unblocked log-hit-test. |
| STORY-EP-075 | Nested enclose capture and empty-child flatten | P0 | SRS-EP-75 / EP-10 | — | **done** | W-nested | — | — | Human-verified 2026-09-05. |
| STORY-EP-076 | Reparent nested ink-box at end of move | P1 | SRS-EP-77 | — | **done** | W-nested | — | — | Human-verified 2026-09-05. 80% natural area; highest paint. Unblocks EP-080. |
| STORY-EP-077 | Clip nested ink-box content to natural world AABB | P0 | SRS-EP-76 / EP-77 | — | **done** | W-nested | — | — | Human-verified 2026-09-05. Overflow not hittable. |
| STORY-EP-078 | Spatial R-tree and named geometry queries | P0 | SRS-EP-79 / EP-78; [ADR-0040](../../.docs/adr/ADR-0040-logarithmic-hit-test.md) proposed | none | **draft** queued | W-log-hit-test | developer (when human picks) | — | Owns the index. Nested tap EP-074 **done**. Do not start while field-latency is NOW unless the human picks this wave. |
| STORY-EP-079 | Migrate point-query callers to geometry index | P0 | SRS-EP-79 / EP-77 / EP-11 / EP-21 | — | **draft** queued | W-log-hit-test | developer (after EP-078) | — | Tap / move / select / finger / paste-tap. Depends on EP-078 + EP-074. |
| STORY-EP-080 | Migrate range 80-percent callers to geometry index | P0 | SRS-EP-79 / EP-11 / EP-10 / EP-75 / EP-58 | — | **draft** queued | W-log-hit-test | developer (after EP-078) | — | Marquee, freeform, enclose, draw-into, move-reparent; object-erase cull only. Depends on EP-078 + EP-076. |
...
| STORY-EP-047 | Recognize and preserve endpoint ink | P1 | SRS-EP-74 / EP-35 / EP-37 / EP-10; [ADR-0038](../../.docs/adr/ADR-0038-endpoint-ink-face-frame.md) | none (Path B, no design story) | **done** | W-endpoint-ink | — | — | Human-verified on device 2026-09-05. Face-frame `{n,e}` on ConnectorAnchor. Steal ≥80% length in 5 mm circle at one end. Path A not this story. |
| STORY-EP-045 | Design connector endpoint style toolbar | P1 | SRS-EP-36 / EP-34 | — | **blocked** | W4 | — | — | Frozen 2026-09-04. Path A toolbar is Infini / web-desktop, not Epaper this campaign. |
| STORY-EP-046 | Apply per-end connector styles from toolbar | P1 | SRS-EP-34 / EP-37 | EP-045 **blocked** | **blocked** | W4 | — | — | Frozen with EP-045. Do not implement. |
...
Wait: do **not** start A and C together (same `tabletcanvasitem.cpp`). Do **not** start [STORY-EP-078](./stories/STORY-EP-078.md)…[STORY-EP-080](./stories/STORY-EP-080.md) until the human picks this wave ([ADR-0040](../../.docs/adr/ADR-0040-logarithmic-hit-test.md) still proposed). Nested tap is **done**. Do **not** start [STORY-EP-073](./stories/STORY-EP-073.md) until the human picks it. Do **not** start Path A [STORY-EP-045](./stories/STORY-EP-045.md) / [STORY-EP-046](./stories/STORY-EP-046.md). Do **not** implement IN-038. Do **not** reopen TRACK-006.
...
| CHL-0011 TBD containment | **scheduled** via [CHL-0032](./challenges/CHL-0032-nested-ink-box.md) — do not reopen the old challenge |
...
[STORY-EP-059](./stories/STORY-EP-059.md)…[STORY-EP-061](./stories/STORY-EP-061.md) **done** (human-verified 2026-08-27). [STORY-EP-062](./stories/STORY-EP-062.md)…[STORY-EP-069](./stories/STORY-EP-069.md) **done** (human-verified 2026-08-31). Field follow-ups [STORY-EP-070](./stories/STORY-EP-070.md)…[STORY-EP-072](./stories/STORY-EP-072.md) **ready**. Nested [STORY-EP-074](./stories/STORY-EP-074.md)…[STORY-EP-077](./stories/STORY-EP-077.md) **done** (human-verified 2026-09-05). Logarithmic hit-test [STORY-EP-078](./stories/STORY-EP-078.md)…[STORY-EP-080](./stories/STORY-EP-080.md) **draft** (queued; [ADR-0040](../../.docs/adr/ADR-0040-logarithmic-hit-test.md) proposed). Clipboard [STORY-EP-044](./stories/STORY-EP-044.md) **done** (human-verified 2026-09-04). Path B endpoint ink [STORY-EP-047](./stories/STORY-EP-047.md) **done** (human-verified 2026-09-05). Path A [STORY-EP-045](./stories/STORY-EP-045.md) / [STORY-EP-046](./stories/STORY-EP-046.md) **blocked**. [STORY-EP-073](./stories/STORY-EP-073.md) later. [CHL-0028](./challenges/CHL-0028-eraser-three-tools.md) **adopted**. [ADR-0034](../../.docs/adr/ADR-0034-erase-clip-remnants.md) **accepted**. [ADR-0035](../../.docs/adr/ADR-0035-tool-context-is-host-ports.md) **accepted**. [ADR-0036](../../.docs/adr/ADR-0036-toolcanvas-live-overlay.md) **accepted**. [ADR-0037](../../.docs/adr/ADR-0037-device-clipboard-singleton.md) **accepted**. [ADR-0038](../../.docs/adr/ADR-0038-endpoint-ink-face-frame.md) **accepted**.
