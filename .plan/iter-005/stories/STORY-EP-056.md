...
Follow-on to [STORY-IN-034](./STORY-IN-034.md) (`done` as Infini desktop — **not** the product). Same package `pen-button-map/`. Parent [REQ-18](../../../.docs/modules/epaper/prd.md#pen-buttons). Human 2026-08-20: editor is **epaper-device**, not Infini.

**Do not** bury viewport-follow or hand-touch scenes here. Infini [REQ-05](../../../.docs/modules/infini/prd.md#pen-button-map) is persist/restore only (`needs_design: no`).
