...
verdict: "NOW — /dev IN-030 ∥ EP-033 (human 2026-08-16); EP-034 USB P1 queued"
wave: W3-parallel
---
...
| Wave **NOW** | W3 | **`/dev` IN-030 ∥ EP-033** (WIP 2 filled) |
| Implement gated | 0 | both lanes ready |
...
personas: /dev (NOW IN-030 ∥ EP-033)
forbidden: REQ-08; CHL-0011; CHL-0012; desktop connector authoring; IN-006 DocChrome
NOW: W3 — /dev STORY-IN-030 ∥ STORY-EP-033
cursor: /dev IN-030 ∥ EP-033
```
...
| **hotfix** | **NOW** | **∥ IN-030** | P0 [STORY-EP-033](./stories/STORY-EP-033.md) origin/stale pen-down |
| **ops** | queued | no conflict vs IN-030 | P1 [STORY-EP-034](./stories/STORY-EP-034.md) USB stay-up / keepalives |
| **W3** | **NOW** | IN-030 ∥ EP-033 | Infini mirror (campaign remaining) |
...
| **H** | [STORY-EP-033](./stories/STORY-EP-033.md) | `tabletappfilter.cpp` + `tabletcanvasitem.cpp` ingest | do not ∥ other `tabletcanvasitem.cpp` work |

EP-031 is **done**. Human 2026-08-16: **both lanes NOW**. Do not start a third `tabletcanvasitem.cpp` story.
...
| F-05 | infini/vector-document (mirror) | Must | thick | n/a | ready | W3 | `/dev` IN-030 | **D** |
...
| BUG-01 | origin/stale pen-down diagonal | P0 | SRS-EP-01 | — | ready | **NOW ∥** | `/dev` EP-033 | **H** |
| BUG-02 | USB Ethernet unreachable until replug | P1 | SRS-EP-08 | — | ready | queued | `/dev` EP-034 | — |

### Current-wave sub-agent roster (spawn when wave = NOW)

| Lane | Agent role | Story | Package / writes | Done when |
|---|---|---|---|---|
| D | dev | [STORY-IN-030](./stories/STORY-IN-030.md) | Infini envelope + derived warp | in-review → `/qa` |
| H | dev | [STORY-EP-033](./stories/STORY-EP-033.md) | origin/stale pen-down | in-review → `/qa` |
...
| Pen-down origin diagonal | STORY-EP-033 — **NOW ∥ IN-030** |
| USB gadget / SSH keepalive | STORY-EP-034 — queued |
...
| local-pen-ink (ingest) | P0 EP-033 **NOW** | **∥ IN-030** |
...
**NOW** — **`/dev` IN-030 ∥ EP-033** (WIP 2 filled). Write sets: `infini/` vs ingest. EP-034 USB stay-up stays queued. REQ-09 select / REQ-10 wait on `/architect`. Do not start REQ-08.
