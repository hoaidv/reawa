...
verdict: "NOW — /dev EP-031 (human verified EP-030); IN-030 optional ∥; EP-034 USB P1 queued"
wave: W3-warp
---
...
| Wave **NOW** | W3 | **`/dev` EP-031** (optional ∥ IN-030) |
| Implement gated | 2 | EP-031 ∥ IN-030 |
...
| **hotfix** | queued | serial vs EP-031 | P0 [STORY-EP-033](./stories/STORY-EP-033.md) origin/stale pen-down |
| **ops** | queued | no conflict vs EP-031 | P1 [STORY-EP-034](./stories/STORY-EP-034.md) USB stay-up / keepalives |
| **W3** | **NOW** | EP-031 ∥ IN-030 | Warp + Infini mirror |
...
|---|---|---|---|
| **C** | [STORY-EP-031](./stories/STORY-EP-031.md) | `epaper/` warp + live drag | **do not ∥ EP-033** (`tabletcanvasitem.cpp`) |
| **D** | [STORY-IN-030](./stories/STORY-IN-030.md) | `infini/` envelope + derived warp | no epaper canvas |

Serial vs EP-033. Infini lane D is optional ∥.
...
| F-04 | epaper/connector-ink (recognize + warp) | Must | thick | EP-027 | recognize **done**; warp NOW | W3 | `/dev` EP-031 | — |
| F-05 | infini/vector-document (mirror) | Must | thick | n/a | ready | W3 | `/dev` IN-030 optional ∥ | **D** |
...
| BUG-01 | origin/stale pen-down diagonal | P0 | SRS-EP-01 | — | ready | queued | `/dev` EP-033 after EP-031 | — |
| BUG-02 | USB Ethernet unreachable until replug | P1 | SRS-EP-08 | — | ready | queued | `/dev` EP-034 after EP-031 | — |

### Current-wave sub-agent roster (spawn when wave = NOW)

| Lane | Agent role | Story | Package / writes | Done when |
|---|---|---|---|---|
| C | dev | [STORY-EP-031](./stories/STORY-EP-031.md) | Ink/Curve warp + live drag | in-review → `/qa` |
| D | dev | [STORY-IN-030](./stories/STORY-IN-030.md) | Infini envelope | in-review → `/qa` |
...
| Pen-down origin diagonal | STORY-EP-033 — queued after EP-031 |
...
| connector-ink | design **done**; recognize **done** | **W3 `/dev` EP-031** |
| local-pen-ink (ingest) | P0 EP-033 queued | after EP-031 |
| ink-box dispatch | **done** (EP-029, human verified) | — |
| infini vector-document | BDD ready | W3 `/dev` IN-030 optional ∥ |

---

## Verdict

**NOW** — **`/dev` EP-031**. EP-030 human-verified. IN-030 optional ∥. EP-033 origin-diagonal and EP-034 USB stay-up stay queued. Do not start REQ-08.
