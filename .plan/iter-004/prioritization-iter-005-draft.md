...
| epaper [REQ-10](../../.docs/modules/epaper/prd.md#hand-touch) two-finger pan/zoom | Finger pan/zoom (same REQ as one-finger pick/move) | Should slice — BRD-07 block |
...
5. REQ-10 two-finger pan/zoom after BRD amendment + ADR
