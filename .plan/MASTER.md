...
| WIP | **2** | EP-034 `/dev` ∥ IN-030 human live review |
...
| TRACK-004 | planned | **active** | **EP-034** · `/dev` ∥ IN-030 live review | [track](./tracks/TRACK-004-on-device-connectors.md) |
...
- [iter-004 execution-board](./iter-004/execution-board.md) — **NOW** `/dev` EP-034 ∥ human IN-030 review
...
- **Now:** IN-032 **done** (human). EP-034 HOLD soak. EP-036 **blocked** [DEF-0001](./iter-004/defects/DEF-0001.md) — gadget/L2 before SSH. Then `/dev`.
- Parked (not committed): epaper `[REQ-08]`, nested enclose (CHL-0011), FREE_FORM / align-content (CHL-0012).
- **Next wave (iter-005, not opened):** draft PRD minted — epaper [REQ-11](../.docs/modules/epaper/prd.md#erase)–[REQ-18](../.docs/modules/epaper/prd.md#pen-buttons), infini [REQ-05](../.docs/modules/infini/prd.md#pen-button-map). Source [BS-0002](./iter-004/brainstorms/BS-0002-iter-005-feature-wave.md). **Do not open iter-005 / do not slice until retro-gate.**
