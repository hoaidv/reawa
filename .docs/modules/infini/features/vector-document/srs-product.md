...
| BR-09e | **Tool state is per device**, never synced. Infini: `Selection` · `Ink-box`. Epaper: `Selection` · `Pen` · `Ink-box` ([epaper REQ-03](../../../epaper/prd.md#tool-modes)). | Modal, but local |
