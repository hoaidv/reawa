...
- Logic: [srs-logic.md](./srs-logic.md) — [SRS-IN-07] · [SRS-IN-17] debug-log `:9878` · [SRS-IN-13] **retired** ·
  [SRS-IN-21] viewport last-writer · [SRS-IN-23] pen-button map publish ([REQ-05](../../prd.md#pen-button-map))
- UI: [srs-ui.md](./srs-ui.md) — [SRS-IN-18] Device Log overlay (`needs_design: false`) ·
  [SRS-IN-24] pen-button map settings (`needs_design: yes`) — **not** [SRS-IN-05](../vector-document/srs-ui.md)
- Quality: [srs-quality.md](./srs-quality.md) — [SRS-IN-08] · [SRS-IN-19] debug isolation · [SRS-IN-25] map publish
...
- Decisions: [ADR-0015](../../../../adr/ADR-0015-one-way-sync-contract.md) ·
  ...
  [ADR-0023](../../../../adr/ADR-0023-viewport-last-writer.md) ·
