...
| [2026-08-31-field-latency.md](./2026-08-31-field-latency.md) | Session index: dense-page hitch, overlay Mono, connector punch, camera LatestJob — what landed vs leftover EP-070/071/072 |
| [ink-path-density-hitch.md](./ink-path-density-hitch.md) | Dense-page ink hitch (verified 2026-08-31) then residual moderate-page lag [STORY-EP-070](../../.plan/iter-005/stories/STORY-EP-070.md); `/tmp/epaper-ink-path.log` |
| [camera-pan-zoom-rasterize.md](./camera-pan-zoom-rasterize.md) | Camera pan/zoom: blit preview + LatestJob sharpen (field: better 2026-08-31); stress probe [STORY-EP-072](../../.plan/iter-005/stories/STORY-EP-072.md) |
